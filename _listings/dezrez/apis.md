...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/plugins/master/_listings/dezrez/apis.md
specificationVersion: "0.14"
apis:
- name: Dezrez.Rezi.Client.Api - Returns the data contract to configure the word plugin
    for creating templates
  x-api-slug: apidocumentgenerationmetadatamajorminorbuildrevision-get
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/plugins/master/_listings/dezrez/apidocumentgenerationmetadatamajorminorbuildrevision-get-openapi.md
- name: Dezrez.Rezi.Client.Api - Returns the data contract to configure the word plugin
    for creating templates
  x-api-slug: apidocumentgenerationmetadatamajorminorbuildrevision-get
  description: Returns the data contract to configure the word plugin for creating
